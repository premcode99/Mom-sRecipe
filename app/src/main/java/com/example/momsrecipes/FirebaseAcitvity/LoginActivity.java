...
public class LoginActivity extends AppCompatActivity {
    ...
    private Button btnSignup, btnLogin, btnReset,loginother;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        loginother = findViewById(R.id.btn_loginwithother);
        ...
        loginother.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginActivity.this, FireBaseAuth.class));
            }
        });
                        ...
                        .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    Intent intent = new Intent(LoginActivity.this, Sliding_activity.class);
